    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            data = [
                {
                    class: "viral_kohli",
                    class_probability: [0.04, 0.77, 3.36, 15.98, 0.03, 79.83],
                    class_dictionary: {
                        lionel_messi: 0,
                        maria_sharapova: 1,
                        ms_dhoni: 2,
                ...
                {
                    class: "roder_federer",
                    class_probability: [0.33, 1.02, 0.88, 96.48, 0.58, 0.72],
                    class_dictionary: {
                         lionel_messi: 0,
                        maria_sharapova: 1,
                        ms_dhoni: 2,
            ...
            */
            ...
            let players = ["lionel_messi", "maria_sharapova","ms_dhoni", "roger_federer", "serena_williams", ];
